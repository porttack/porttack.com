...
Additionally, SLV Middle School is excited to provide your child with access to the educational platform called "Grok Academy." Grok Academy offers interactive coding exercises and educational content, which can help students learn valuable computer science and programming skills.

We kindly request your explicit parental consent to use the Grok Academy platform. This consent is required to comply with the Children's Online Privacy Protection Act (COPPA), which is a United States federal law designed to protect the online privacy of children under the age of 13.

By signing this consent form, you, as the parent or legal guardian, hereby grant permission for your child to use the Grok Academy platform provided by SLVUSD. 

For more information, see [Grok Academy Policies & Procedures](https://groklearning.com/policies/privacy/).
