...
The [Salamanca City Central School District](https://www.newsnationnow.com/us-news/education/new-york-school-district-humanoid-robot-teacher/) is a small, rural district of about 1,300 students. It's the only incorporated city in the United States that sits entirely within a Native American reservation, the Seneca Nation. Roughly a third of its students identify as American Indian or Alaska Native, and nearly 80% are economically disadvantaged.

For $57,590, discounted from a $95,000 list price, the district bought a Realbotix M-Series humanoid unit plus an AI teaching-assistant program called **Optio**. Here's what Sally is and isn't:

- **Stationary.** Sally moves her arms, head, and facial expressions from a seated position. She does not walk the halls.
- **A tutor, not a teacher.** She was aimed at 11th and 12th graders in coding, robotics, and AI courses, running a STEM curriculum developed by Apple co-founder Steve Wozniak, with after-hours homework help through an avatar on student laptops.
- **Locked down, by design.** Superintendent Mark Beehler described a closed school network with no open internet access, no facial recognition, no audio or video recording, and no student data going back to Realbotix. Flagged terms like references to self-harm would alert administrators, and the system was trained to say "I don't know" rather than hallucinate.
- **Personalized, and persistent.** Students would log in with a unique ID code so the system could pull their learning history. Realbotix CEO Andrew Kiguel described the robot greeting a student by picking up the thread of what they had been discussing the day before.

Beehler's pitch is one I have sympathy for. He argues that banning technology is the easy way out (students route around bans anyway), and that a district like his rarely gets first crack at emerging tech. He framed it as a way to cross the geographic and economic barriers his students face.

## The part the district would rather you skip

Here's the detail that turned a local ed-tech story into a national one. Realbotix didn't come from the world of education. The company is the descendant of **Abyss Creations**, the maker of RealDoll (yes, the sex dolls), which [pivoted into "companionship" robotics](https://www.therobotreport.com/realbotix-makes-transition-from-novelty-to-embodied-ai/) after a crypto shell company, formerly Tokens.com, acquired its parent in 2024. Its CES showpiece last year, a robot named Aria, drew so many sex-doll comparisons that the company [publicly clarified she has no genitalia](https://futurism.com/aria-realbotix-genitals-sex).
...
The union wasn't alone. The Alliance for Quality Education argued that underserved students were being made [guinea pigs for untested innovation](https://dailycaller.com/2026/07/20/new-york-salamanca-school-district-robot-ai-classroom-sally-realbotix/), and that the years when children develop socially and emotionally are not years to outsource to a robot, however human it looks. A local parent told New York Focus that adding AI to a community already facing hard problems felt like contradicting everything they believe.
